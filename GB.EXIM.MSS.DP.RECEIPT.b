* @ValidationCode : MjoxNzEzNTkzNjI3OkNwMTI1MjoxNTc3MDk2NDgzNzY3OnVzZXI6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAxNzEwLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 23 Dec 2019 16:21:23
...
SUBROUTINE GB.EXIM.MSS.DP.RECEIPT(Y.RETURN)
*-----------------------------------------------------------------------------
*
*-----------------------------------------------------------------------------
...
*____CREDIT ACCT_RECEIVED FROM____
    ...
    Y.CUS.NAME.2 = REC.CUS<ST.Customer.Customer.EbCusShortName>[1,15]


*    Y.CR.ACC = REC.AA.ID<AA.Framework.ArrangementSim.ArrCustomer>
*    REC.ACCT<AC.AccountOpening.Account.ShortTitle>
*    EB.DataAccess.FRead(FN.CUSTOMER, Y.CR.ACC, REC.CUS, F.CUSTOMER, ERROR.CUS)
*    Y.CUS.NAME = REC.CUS<ST.Customer.CustomerStatus.EbCstShortName>
*
...
*PRINT AREA
    ...
    Y.AMT.WRD.1 = "||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||":TXTVAR1
    Y.TRM.1 =     "|||||||||||||||||||||||||||||||||||||||||||||||||||||":FMT(Y.AMT, 'R2,#19'):"|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||":Y.TRM
    Y.TRM.2 =     "|||||||||||||||||||||||||||||||||||||||||||||||||||||":Y.TRM
    Y.AMT.1 =     "||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||":FMT(Y.AMT, 'R2,#19')
   
    Y.RETURN = Y.BLNK.LINE:"^":Y.BLNK.LINE:"^":Y.BLNK.LINE:"^":Y.BLNK.LINE:Y.BLNK.LINE:"^":Y.BLNK.LINE:"^":Y.DATE.1:"^":Y.BLNK.LINE:"^":Y.BLNK.LINE:"^":Y.BLNK.LINE:"^":Y.CUS.NAME.1:"^":Y.CUS.NAME.2:'^':Y.AMT.WRD.1:"^":Y.BLNK.LINE:'^':Y.TRM.1:"^":Y.BLNK.LINE:"^":Y.TRM.2:"^":Y.BLNK.LINE:"^":Y.BLNK.LINE:"^":Y.AMT.1
