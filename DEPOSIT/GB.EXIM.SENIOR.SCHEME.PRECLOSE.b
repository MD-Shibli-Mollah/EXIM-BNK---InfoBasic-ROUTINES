* @ValidationCode : MjoxMjgwMDgwNTQ1OkNwMTI1MjoxNTgxNDg1MDMzNjg3OkRFTEw6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAxNzEwLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 Feb 2020 11:23:53
...
SUBROUTINE GB.EXIM.SENIOR.SCHEME.PRECLOSE(arrId,arrProp,arrCcy,arrRes,balanceAmount,perDat)
*-----------------------------------------------------------------------------
*
*-----------------------------------------------------------------------------
...
*--------------------------------------------PREMATURE PROFIT----------------------------------------------
        CASE Y.DAYS GE 360 AND Y.DAYS LT 720
            GOSUB ACTUAL.PROFIT
...
GET.SVR.FIND.INTEREST:
    Y.SRC.ID = '4BDT' ;* 4BDT FIXED FOR RETAILS ACCOUNT INTEREST
