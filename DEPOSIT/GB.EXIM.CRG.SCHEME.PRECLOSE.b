* @ValidationCode : MjoxNjUwNzYxOTM2OkNwMTI1MjoxNTgxNDE5MDU2MjcyOkRFTEw6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAxNzEwLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Feb 2020 17:04:16
...
SUBROUTINE GB.EXIM.CRG.SCHEME.PRECLOSE(arrId,arrProp,arrCcy,arrRes,balanceAmount,perDat)
*-----------------------------------------------------------------------------
*
*-----------------------------------------------------------------------------
...
*--------------------------------------------AFTER 3 YEARS PROFIT----------------------------------------------
        CASE Y.DAYS GE 1080 AND Y.DAYS LT 1800
            ...
            IF NUM.OF.REPAY GE 36 THEN
                Y.AA.INT.ID = 'EXIM.PFT.MDS3Y.DP-BDT--20040101'
...
*--------------------------------------------AFTER 5 YEARS PROFIT----------------------------------------------
        CASE Y.DAYS GE 1800 AND Y.DAYS LT 2880
            ...
            IF NUM.OF.REPAY GE 60 THEN
                Y.AA.INT.ID = 'EXIM.PFT.MDS5Y.DP-BDT--20040101'
                GOSUB GET.PRD.INTEREST.RATE
                NO.OF.LOOP = 60
                START.FORM.I = 1
                GOSUB GET.BASIC.DETAILS.WITH.SLAB
...
*--------------------------------------------AFTER 8 YEARS PROFIT----------------------------------------------
        CASE Y.DAYS GE 2880 AND Y.DAYS LT 3600
            ...
            IF NUM.OF.REPAY GE 96 THEN
                Y.AA.INT.ID = 'EXIM.PFT.MDS8Y.DP-BDT--20040101'
                GOSUB GET.PRD.INTEREST.RATE
                NO.OF.LOOP = 96
                START.FORM.I = 1
                GOSUB GET.BASIC.DETAILS.WITH.SLAB
...
*--------------------------------------------AFTER 10 YEARS PROFIT----------------------------------------------
        CASE Y.DAYS GE 3600 AND Y.DAYS LT 4320
            ...
            IF NUM.OF.REPAY GE 120 THEN
                Y.AA.INT.ID = 'EXIM.PFT.MDS10Y.DP-BDT--20040101'
                GOSUB GET.PRD.INTEREST.RATE
                NO.OF.LOOP = 120
                START.FORM.I = 1
                GOSUB GET.BASIC.DETAILS.WITH.SLAB
...
*--------------------------------------------AFTER 12 YEARS PROFIT----------------------------------------------
        CASE Y.DAYS GE 4320 AND Y.DAYS LT 7200
            ...
            IF NUM.OF.REPAY GE 144 THEN
                Y.AA.INT.ID = 'EXIM.PFT.MDS12Y.DP-BDT--20040101'
                GOSUB GET.PRD.INTEREST.RATE
                NO.OF.LOOP = 144
                START.FORM.I = 1
                GOSUB GET.BASIC.DETAILS.WITH.SLAB
