* @ValidationCode : MjotMTkzMjEyNDkyMDpDcDEyNTI6MTU4MTQxOTMzMTA2ODpERUxMOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMTcxMC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 11 Feb 2020 17:08:51
...
SUBROUTINE GB.EXIM.CRG.KRISHI.PRECLOSE(arrId,arrProp,arrCcy,arrRes,balanceAmount,perDat)
*-----------------------------------------------------------------------------
*
*-----------------------------------------------------------------------------
...
*--------------------------------------------AFTER 3 YEARS PROFIT----------------------------------------------
        CASE Y.DAYS GE 1080 AND Y.DAYS LT 1800
            ...
            IF NUM.OF.REPAY GE 36 THEN
                Y.AA.INT.ID = 'EXIM.PFT.MKMS3Y.DP-BDT--20040101'
...
*--------------------------------------------AFTER 5 YEARS PROFIT----------------------------------------------
        CASE Y.DAYS GE 1800 AND Y.DAYS LT 2880
            ...
            IF NUM.OF.REPAY GE 60 THEN
                Y.AA.INT.ID = 'EXIM.PFT.MKMS5Y.DP-BDT--20040101'
                GOSUB GET.PRD.INTEREST.RATE
                NO.OF.LOOP = 60
                START.FORM.I = 1
                GOSUB GET.BASIC.DETAILS.WITH.SLAB
