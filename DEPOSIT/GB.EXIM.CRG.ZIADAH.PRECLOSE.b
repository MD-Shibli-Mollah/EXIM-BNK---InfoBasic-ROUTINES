* @ValidationCode : MjotMTg4MTE3MDY1MzpDcDEyNTI6MTU4MTI0MDEzNDA3MTpERUxMOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMTcxMC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 09 Feb 2020 15:22:14
...
SUBROUTINE GB.EXIM.CRG.ZIADAH.PRECLOSE(arrId,arrProp,arrCcy,arrRes,balanceAmount,perDat)
*-----------------------------------------------------------------------------
*
*-----------------------------------------------------------------------------
...
*--------------------------------------------PREMATURE PROFIT----------------------------------------------
        CASE Y.DAYS GE 360 AND Y.DAYS LT 1080
            ...
            balanceAmount = (Y.ACT.PROFIT) - (Y.TOT.PROFIT+Y.TOT.PRINCIPAL.INT.RUHAMA+AFTER.RUHAMA.PRIN)
