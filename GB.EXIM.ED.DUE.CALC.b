* @ValidationCode : MjotMjAyMTAwMDIzNDpDcDEyNTI6MTU4Mzk5Mzg0NDAxNDpERUxMOi0xOi0xOjA6MDpmYWxzZTpOL0E6REVWXzIwMTcxMC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 12 Mar 2020 12:17:24
...
********
    ...
    Y.ACTIVITY.DATE = activityrecord<AA.Framework.ArrangementActivity.ArrActEffectiveDate>
    
    IF Y.RENEW.DATE EQ Y.ACTIVITY.DATE THEN RETURN
    
    Y.DATA = arrId:'*':Y.RENEW.DATE:'*':EB.SystemTables.getToday()
    Y.DIR = 'EXIM.DATA'
    Y.FILE.NAME = 'ED'
